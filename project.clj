(defproject issues-combined "0.1.0-SNAPSHOT"
  ...
  {:uberjar {:omit-source true
             ...
             :aot :all
             :uberjar-name "issues-combined.jar"
                   ...
                   {:test
                    {:source-paths ["src/cljc" "src/cljs" "test/cljs"]
                     ...
                     {:output-to "target/test.js"
                      :main "issues-combined.doo-runner"
